    ...
    BasketScene *parent)
{
    ...
    // A shelf no longer owns visual appearance or layout.
    // Those properties belong to Pages.
    //
    // Therefore a new shelf starts with a deliberately minimal file:
    // identity + empty Mathom list. The first Page will create and own
    // its own disposition when needed.
