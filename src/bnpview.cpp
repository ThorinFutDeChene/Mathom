...
void BNPView::notesStateChanged()
{
    ...
    if (currentBasket()->isLocked())
        ...
        QString count = i18np("%1 mathom", "%1 mathoms", basket->count());
        ...
        setSelectionStatus(i18nc("e.g. '18 mathoms, 10 matches, 5 selected'", "%1, %2, %3", count, showns, selecteds));
    }
